...
// color / "Monet" isn't available) — matches the purple-to-blue gradient
// used in the app icon.
private val FallbackPrimary = Color(0xFF7C4DFF)
private val FallbackSecondary = Color(0xFF448AFF)
...
private val LightIos27 = lightColorScheme(
    ...
    secondaryContainer = Color(0xFFF4F7FB),
...
private fun lightMinimalScheme(primary: Color, secondary: Color) = lightColorScheme(
    ...
    surfaceVariant = blendColors(Color(0xFFF5F8FF), primary, 0.055f),
    onSurface = Color(0xFF1C1C1E),
    onSurfaceVariant = Color(0xFF636366),
    primaryContainer = blendColors(Color(0xFFFFFFFF), primary, 0.14f),
    secondaryContainer = blendColors(Color(0xFFFFFFFF), primary, 0.10f),
    onSecondaryContainer = Color(0xFF0F172A)
)
...
private fun darkMinimalScheme(primary: Color, secondary: Color) = darkColorScheme(
    ...
    surface = Color(0xE624252B),
    surfaceVariant = blendColors(Color(0xFF2A2B32), primary, 0.08f),
    onSurface = Color(0xFFF5F5F7),
    onSurfaceVariant = Color(0xFFAEAEB2),
    primaryContainer = blendColors(Color(0xFF2A2B32), primary, 0.22f),
    secondaryContainer = blendColors(Color(0xFF343438), primary, 0.20f),
...
private val DarkIos27 = darkColorScheme(
    ...
    onSurface = Color(0xFFF5F5F7),
    onSurfaceVariant = Color(0xFFAEAEB2),
    primaryContainer = Color(0xFF223B4A),
    secondaryContainer = Color(0xFF343438),
    onSecondaryContainer = Color(0xFFF5F5F7)
)
